...
import 'package:pokedex_provider/screens/detail/widgets/about.dart';
import 'package:pokedex_provider/screens/detail/widgets/baseState.dart';
import 'package:pokedex_provider/screens/detail/widgets/moves.dart';
...
class _PokemonDetailPageState extends State<PokemonDetailPage> {
  ...
  Widget build(BuildContext context) {
    log('_PokemonDetailPageState build');
    return Consumer<PokeDetailNotifier>(
      builder: (context, model, child) {
        if (!model.isLoading) {
          pokemonSpecies = model.pokemonSpecies;
          pokemonDetail = model.pokemonDetail;
        }
        return Scaffold(
